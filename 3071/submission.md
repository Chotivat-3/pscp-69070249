...
```text
โจทย์กำหนดช่วงมาให้เรา (range) แล้วถามว่า มีจำนวนนับกี่ตัวในช่วงนี้ที่หาร ด้วย d แล้วเหลือ เศษ r
```
...
```text
รับค่า เข้ามา
สร้างค่า  n = 0 ไว้รับจำนวนที่หารแล้วตามที่กำหนด
สร้างfor loop
แล้วกำหนด if i%d == r : ให้ n += 1  
จากนั้น print(n)
```
...
```text
ทำเหมือน วิธีที่ 1 คือ สร้างฟอลุป กำหนด ค่า เก็บค่ากรณรีที่เข้าเงื่อนไข ปริ้น ออกมา
```
