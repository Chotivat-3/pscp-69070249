...
```text
โจทย์ ต้องการ ให้ส่ง output บอกว่า เป็นฤดูไหน  จากการรับ input  คือเดือนและวันที่ โดยให้เงื่อนไข มา คือ ทุก 3 เดือนจะเปลี่ยนฤดู โดยเริ่มจาก winter ไล่ไปจนถึง fall และในทุกเดือนที่หารสามลงตัว หรือ มุกเดือนสุดท้ายของฤดูถ้าเกิดเป็นวันที่ 21 ขึ้นไปจะเปลี่ยน ฤดูเป็นฤดูถัดไป
```
...
```text
สร้าง dict ขึ้นมาเพื่อเก็บข้อมูลเดือนและฤดูกาล จากนั้น รับ input เดือน และ วันเข้ามา จากนั้นตั้งเงื่อนไข หากเดือน เป็นเดือนที่หาร 3 ลงตัว และ วันที่ มากกว่า 21 ให้เปลี่ยนเป็นฤดูถัดไป อันนี้ในตอนนั้น ผมลืมนึกถึง not D%3 จึงได้สร้าง list เก็บเดือนที่หารสามลงตัวไว้แล้วเอามาตั้งเงื่อนไข if แทน ถ้า หารลงตัว จะให้ m += 1 เพื่อเป็นการเรียกข้อมูลจาก dict ที่เก็บไว้
```
...
```text
คล้ายแผนแรกแต่ เพิ่มเงื่อนไขที่ว่า ถ้า ท == 13 ให้รีกลับไปที่ 1 เพราะมันคือการวนกลับไปเดือนที่ 1 จากนั้นสุดท้ายค่อยปริ้น value ด้วย key m 
```
...
```text
กรณีที่เปลี่ยนแปลงฤดูของเดือน 12
```
...
```text
กรณีวันที่ 21 ของเดือนที่หารสามไม่ลงตัว
```
