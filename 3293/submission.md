...
```text
ตัวโจทย์ บอกว่า จะให้ค่า อินพุทมาเป็น string จำนวน 5 บรรทัด
และให้เราปริ้นออกมาในรูป แบบบ ช้อความในกล่อง
```
...
```text
ในตอนแรก ผมก็รับข้อความเข้ามาเก็บใน list และจากนั้นหาข้อความที่ยาวที่สุด 
เพื่อไปใช้สร้างขนาดของกล่อง  ต่อมา ก็จัดรูปแบบการพิมพ์ใน for loop ขอบเขต (1,8)
เนื่องจากเราจะมี 7 บรรทัด จากนั้น ผมก็ได้ กำหนดการพิมพ์ว่าถ้า i เนี่ย อยู่ใน (1,7)
ให้พิมพ์ดอกจันทร์ล้วน*maxtext+4 ส่วนบรรทัดอื่นๆ ให้พิมพ์ดอกจันทร์+spacce หน้า text
และเติมspace_barจนกว่าจะเท่าจำนวนmaxtext จากนั้นพิมพ์space+ดอกจันทร์ปิด
```
...
```text
เหมือนแผนแรกเลยครับแต่ ได้มีการใช้ try , except เพราะว่า ในโจทย์นี้มีการให้อินพุทที่ทำให้เกิด EOF error ครับผม
```
...
```text
ทดลองรูปแบบต่างๆที่สามารถทำให้ผิดผลาดได้
```
...
```text
ทดลองว่ากล่องสร้างตามขนาดข้อความที่ใหญ่สุดจริงไหม
```
...
baaaaaaaaaaaaaaaa
baka
bakakakakkakakakakakakakakakakkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkakkkkkkkkkkkkakaka
ba
```
