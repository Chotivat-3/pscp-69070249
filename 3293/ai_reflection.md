...
| OJ submission ID, if submitted | 	635287 |
| OJ status | Pass |
...
```text
มี การใช้ try, except ใน python ด้วย
```
...
```text
ตรวจสอบว่าการเกิด Error มาจากไหน
```
...
```text
รู้การมีอยู่ของ try , except
รู้ว่า มีโอกาศที่โจทย์จะทำให้เกิด เออเล่อ แต่เรายังต้องรันโค้ดต่อไป
```
