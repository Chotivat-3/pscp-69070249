...
```text
โจทย์ต้องการให้ทำโปรแกรมคำนวณอุณหภูมิให้ได้ตามที่ต้องการเช่น การเปลี่ยนจาก เซลเซียส เป็นฟาเรนไฮด์ โดย input จะมี สามบรรทัด 1.ค่าอุณหภูมิ 2.ชนิดของอุณหภูมิ 3.อุณหภูมิที่ต้องการให้เปลี่ยนไป out put ก็คืออุณหถูมิตามหน่วยที่ต้องการให้เปลี่ยน 
```
...
```text
ด้วยความที่ฐานของสูตรมันมีองศาเซลเซียสทุกตัวเลย ผมจึงต้องการให้โปรแกรมของผมเนี่ย รับค่าที่เข้ามาแล้วทำให้เป็นค่าองศาเซลเซียสเก็บไว้ก่อน(เพื่อความสะดวกของตัวผมเอง) ผมจึงทำ ฟังก์ชั่น c ไว้เพื่อรับค่าอุณหภูมิในหน่อยองศาเซลเซียสไว้ จากนั้น ในฟังก์ชั่น tem คือผมเอาไว้แปลง อุณหภูมิจากหน่วยองศาเซลเซียส เป็นอุณหภูมิที่ผมต้องการ และสุดท้ายก่อนจะปริ้นออกผม ได้กำหนดให้ มีทศนิยม2ตำแหน่งตามโจทย์บอกด้วยการใช้ f'string 
```
...
```text
ผมใช้วิธีเหมือนกับวิธีแรกเลยครับ เพียงแต่มีการปรับเปลี่ยนชื่อตัวแปรบางตัว เพื่อให้ถูกหลัก pep-8 
```
...
```text
เป็นการดูเงื่อนไขที่ผมชอบมองข้ามครับ คือการที่ไม่มีการเปลี่ยนแปลงอะไร
```
...
```text
ทดสอบการเปลี่ยนปกติ ที่เลขส่งออกเป็น เลขลงตัว ว่า มี .00 ไหม
```
