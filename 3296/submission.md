...
```text
ในตอนแรก ผมอ่านโจทย์แล้วผมงงมากครับว่า in spec เป็นจุดสี แล้วผมต้องทำยังไงต่อ 
จะรับค่ายังไงเอาไปผสมยังไง จน ผมเอาไปถาม พี่ TA ใน คลาส จึงได้แนวคิด โจทย์ข้อนี้
แค่การเอาเลขค่า RGB มาหา สีก็พอ ก็คือ เอามาบวกกัน หาร 2 เพื่อหาค่าตรงกลางครับ
```
...
```text
ครับ รับค่าเข้ามา แบ่ง 3 ตัวแปร 2 รอบ นำมา+กัน และหารสองแบบไม่เอาเศษ จากนั้น ปริ้นออกมา
```
...
```text
เหมือนวิธีแรกเลยรับครับ รับค่ามา+กันแล้วหาร
```
...
```text
ช่วยบอกว่าข้อนี้ input ที่เข้ามาเป็นชุดตัวเลข
```

คุณยังทำอะไรด้วยตนเอง

```text
การเขียนโปรแกรมในส่วนการ รวมค่าและหารออกมา
```
