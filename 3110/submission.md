...
```text
โจทย์ ข้อนี้ต้องการให้แสดงราคา จากการขนส่งพัสดุ โดย โจทยได้กำหนด ต้นทางปลายทางและค่า ฑรรมเนียมมา และ ถ้า หาก อยู่นอกขอบเขตตามที่โจทย์กำหนดให้ เป็น ERROR
```
...
```text
ด้วยความ ที่โจทย์ ให้ข้อมูล อินพุทมาเป็น [ต้นทาง ปลายาง]
ผมจึง ใช้ จุดนี้ในการ สร้าง dict เก็บ ข้อมูล ค่าเพิ่มเติม จากน้ำหนัก และ ค่าบริการพื้นฐาน
โดย ที่กำหนด key คือ [ต้นทาง ปลายทาง] value คือ [ราคา]
จากนั้นตั้ง if else ถ้าเกิด ว่า input ที่รับเข้ามา ไม่เป็น key ใน dict ให้ out =  "Error"
แต่ถ้าอยู่ใน dict ให้
out = น้ำหนนัก*ค่าบริการเพิ่มเติม[keyที่inputมา] + ค่าบริการพื้นฐาน[keyที่inputมา]
จากนั้นก็ print(out)
```
...
```text
ทำตามวิธีแรก เลยครับ เก็ยข้อมูลไว้ใน dict  รับ input เข้ามา ถ้าอยู่ใน dict ก็ให้ เรียกค่าออกมาใช้และเก็บไว้ในตัวแปร out ถ้า ไม่อยุ่ ก็ ให้ เก็บ คำว่า "Error" ไว้ใน out สุดท้าย ปริ้น out ออกมา
```
...
```text
ลองดูว่า ถ้า เกิด input อยู่นอก dict จะ Error ไหม
```
...
```text
ลอง เป็น ชื่อ ที่อยุ่อยุ่ใน ตาราง แต่ เป็นอันที่ไม่ได้คู่กัน
```
