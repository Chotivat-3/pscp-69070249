...
```text
โดย โจทย์ ข้อนี้ให้เราหา จำนวนอิฐที่มใช้สร้างสะพานตามความยาวที่กำหนด 
แต่สิ่งที่โจทย์ ต้องการรุ้คือจำนวนของอิฐก้อนเล็กที่น้อยที่สุดที่ใช้ในการสร้าง
ปละมีเงื่อนไข คือ เราต้องสร้าง โดยที่ ใช้ก้อนใหญ่ให้ได้มากที่สุดก่อน ถึงจะใช้ก้อนเล็ก
```
...
```text
ในตอนแรก ผม ใช้วิธี ในการ หา ขนาดสะพานที่สร้างได้จากหินก้อนใหญ่ก่อน
จากนั้นนำมาคิดต่อ ถ้าเกิด ขนาดที่ได้ยังไม่เทียบเท่าสะพานให้ หาเศษเหลือที่ต้องการ
และ เสษไว้ในตัวแปร out โดย ที่ ก่อนหน้าได้ตั้งให้ out = 0 
ก็ คือ ถ้า เกิด ว่า มีเศษเเหลือ out ก็จะเท่ากับเศษที่เหลือ 
แต่ทีนี้ ผมคิดแค่ว่าถ้าเอาเศษอันนี้ไปรวม กับสะพานจากชิ้นใหญ่ก่อนหน้า 
แล้วได้ขนาดเท่ากับ ที่ต้องการ ให้ปริ้นเศษเป็นจำนวน ของอิฐก้อนเล็กได้เลย
ทะว่า การทำแบบนี้เท่ากับไม่ได้เช็คเลยว่าจำนวนอิฐเล็กพอหรือไม่ 
ดังนั้นมันจะไม่มีทางปริ้น -1 ออกมาแน่นอน
```
...
```text
หา ว่า จาก สะพานเนี่ย เราต้องใช้ อิฐก้อนใหญ่ทั้งหมดกี่ก้อนโดยใช้ 
n_b(จำนวนอิฐก้อนใหญ่ที่ต้องการ) = g(ขนาดสะพาน)//5
จากนั้นก็นำมาเทียบว่า จำนวนอิฐที่ได้มาเนี่ย จะได้ ใช้อิฐก้อนใหญ่ทั้งหมดกี่ก้อน
โดยที่เราเอา ก้อนใหญ่ที่ต้องการ มาเทียบ กับ ก้อนใหญ่ี่มี
และกำหนดค่าก้อนใหญ่ที่ใช้ให้เท่ากับจำนวนที่น้อยที่สุดใน สองตัวดังกล่าว
เพื่อนนำมาคิดจำนวนก้อนเล็ก ต่อ ด้วยการที่ กำหนดจำนวนก้อนเล็กที่ต้องการ
คือ n_a = g - (ก้อนใหญที่ใช้)*5
แล้วนำก้อนเล็กที่ต้องการไปเทียบกัยก้อนเล้กเล็กที่ใช้ว่าพอไหม
ถ้าเกิดพอก็ปริ้นจำนวน ก้อนเล็กที่ได้
ถ้าไม่พอก็ปริ้น -1
```
...
```text
มีก้อนใหญ่เยอะมากกว่าที่ต้องการแต่ก้อนเล็กไม่มี
```
