...
```text
input  1. เลขผลรวมของ ทั้งหมด 3 คน 2. คะแนนสูงสุดของทั้งสามคน
output บอกว่า มีโอกาศหรือไม่มี โดยปริ้น Surprising หรือ Not surprising 
ก็คือโจทย์อะ บอกคะแนนรวมมาแล้วก็บอกคะแนนสุงสุด ละกำหนดว่าถ้าคะแนนต่ำสุดเนี่ยต่างกับคะแนนสูงสุดเกิน 2 จะถือว่ามีโอกาศโกงผล โดย ที่แต่ละคนจะโหวดได้แค่ [0,10] เป็นจำนวนจริง ดังนั้นก็คือโจทย์เนี่ยอยากจะรู้ว่าจากคะแนนรวมและคะแนนสูงสุดมที่ให้มาเนี่ยมีโอกาศในการที่จะมีหน้าม้ามาโหวตไหม
```
...
```text
ในตอนแรก ผมกำหนดเงื่อนไขจากการที่ให้อีก 2 คะแนนโหวด มีคะแนนเท่ากัน โดยใช้เป็น คะแนนรวม-คะแนนสูงสุดแล้วจากนั้นนำมาหารสอง แล้วผมเอาไปคิดเป็นระยะห่าง ว่าถ้าค่านี้ ห่างจากคะแนนสูงสุดเกิน 2 คะแนนให้ถือว่ามีโอกาศ ทว่าเงื่อนไขที่ตั้งนั้นไม่ได้ครอบคลุม ผมจึงไปหาและคิดใหม่
```
...
```text
ทีนี้ ผมมาจับคอนเซปต์ได้ประมาณว่า ในค่าสูงสุด 1 ค่าเนี่ย มันจะเริ่มีโอกาศ เมื่อ คะแนนรวม ต่ำกว่าค่าๆนึง คือ (ค่าของ จำนวนสูงสุด*3)-2 ถ้าเเกิดว่า ค่ารวมต่ำกว่าค่านี้จะเริ่มมีโอกาศแล้ว เนื่องจาก สมมติว่า max = 10 ค่า max*3 = 30 ซึ่งคือค่าคะแนนโหวตสูงสุดที่เป็นไปได้ จากนั้น เมื่อลองลดค่าลงมาเรื่อยๆ จน ถึง 28 จะเห็นว่า ถ้าเราให้ ค่าสูงสุดมีสอวค่า คือ 10 จะได้ (10,10,8)ค่าสุดท้ายที่ต่ำสุดคือ8 แสดงว่าหลังจากที่คะแนนรวมต่ำกว่า 28 นั้นจะทำให้ มีโอกาศเกิดการใช้หน้าม้าขึ้น และ ยังมีอีกเงื่อนไขนึงที่ต้องระวังคือ ถ้าผมใช้ สูตร นี้ ตอนที่ x น้อยกว่า 2 มันมีโอกาศติดหน้าม้า จากการคำนวณทว่าในความจริงโจทย์กำหนดว่า ระยะห่างต้องมากกว่าสองดังนั้นเมื่อเลขสูงสุดเป็นสองจึงไม่มีโอกาศแน่นอนจึงต้องกำหนดเงื่อนไขนี้เป็นอันแรกก่อนจะไปเงื่อนไขถัดไป ที่ว่า ถ้าจำนวนรวม น้อยกว่า (ค่าของ จำนวนสูงสุด*3)-2  ให้ถือว่าเกิด และถ้านอกเหนือจากนั้นถือว่าไม่เเกิด โดยใช้ if elif else ในการกำหนดเงื่อนไขต่างๆ 
```
...
```text
ทดสอบสูตร ว่า ถ้าเกิดเลขที่ได้มาเนี่ย เป็น ทศนิยมมันจะได้ผลลัพธ์ตามต้องการไหม
```
