...
```text
รับข้อความมาแล้วนับว่ามีสระ อะไรบ้างและแต่ละตัวมีจำนวนเท่าไหร่
จากนั้นแสดงผลแค่สระที่นับจำนวนได้
```
...
```text
อย่างแรกผมใช้.lowwer()กับข้อความที่ได้มากอน เพื่อให้เวลาที่ตรวจจะได้ไม่ตกหล่น
ต่อมา ผมนับจำนวนสระที่มีในข้อความด้วย .count()
จากนั้นผมสร้าฟังก์ชั่นสำหรับ print(สระและจำนวนสระออกมา)
โดย ผมกำหนด พารามิเตอร์ของ ฟีงก์ ชั่น คือ จำนวน และตัวสระ 
แล้วผมใช้ if x(จำนวนสระ): print(สระ : จำนวน)

จากนั้นเรียกใช้ฟังชั่น โดย ที่ ใส่ อาร์กิวเมนต์ คือ จำนวน และ ตัวสระ 
ไล่เรียกจนครบทุกตัว
```
...
```text
เหมือนวิธีแรกเลย รับ ข้อความเข้ามา นับ และ ใช้ฟังก์ชั่นสำหรับการ print() 
```
