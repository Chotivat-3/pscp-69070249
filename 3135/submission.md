...
```text
โดย ที่โจทย์ ข้อนี้ พูดถึงการ สับเปลี่ยนของเป็นวงกลมประมาณนั้นครับ
โดยโจทย์ จะกำหนด ขนาดวง ขนาดการเคบื่อนที่ และ จุดที่มีขโมย
โดย เงื่อนไขคือ จะหยุด เมื่อ ตอนที่ ของ วนไป ที่คนหมายเลข 1 หรือ เป็นหมายเลขที่เป็นโจร
และเอ้าพุทของโจทย์นั้นต้องการ ทราบว่า วนไปกี่ครั้ง
```
...
```text
ก็คือ รับ ค่า จำนวนรอบ ขนาดก้าว และตำแหน่งโจรมา (n,k,t) โดยที่ เราจะ กำหนด การวน
ด้วยการ ใช้ While แล้ว บวก ค่า เท่ากับ K ไปเรื่อยๆ และ ถ้า ค่าที่ได้เกิน n ก็จะ - ด้วย n 
เพื่อให้เป็นการวนอยู่ในวงกลม ปละ ทุกครั้ง ที่มีการ + ให้  บวก เทรินไป = 1 
และเมื่อ เลขวนไปเท่ากับ 1 หรือ เลข โจทร ให้หยุด จากนั้น ส่งออกเทริน
```
...
```text
ท้าคล้าย เดิม เพียงแต่มีการเพิ่มเงื่อนไข เพระจากโจทย์ บอกว่า ให้นับ จำนวนคนที่ได้พิจารณา
โดยที่จากโคดที่แล้ว ผม นับ แค่ เทรินที่มีการเดิน ดังนั้น ในตอนที่จบโดย การโดน โจร ปล้น 
ต้อง  + เทริน เท่ากับ 1 ด้วย เพราะมีอีกคนที่ได้พิจารณาในเทรินนี้
```
