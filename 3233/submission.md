...
```text
โจทย์ฟิลให้เราทำที่ตรวจสลากน่ะครับโดยโจทย์จำกำหนดเงื่อนไขรางวัลมาให้เราก็ตั้ง if elif else 
ให้ครบตาเงื่อนไขไป
```
...
อย่างแรกรับค่า 
 1. ที่ถูกรางวัล
2. ที่ ซื้อ
โดย จะแบ่งเป็นหมวดตัวอักษร ตัวเลข ใช้ split แยก และ เก็บค่า เอาไว้ ใน 2 ตัวแปร
จากนั้น มาตั้งเงื่อนไขตามที่โจทย์กำหนดเลย
อย่างแรกคือเหมือนกันทั้งหมด ได้ 1000000
ต่อมา ตัวอักษรเหมือน เลข ไม่เหมือน ได้ 100000
และอื่นๆข้างล่างจะเป็นเงื่อนไข ของ ที่อักษรเหมือน และไม่เหมือน เพิ่มเติม 
คือ มีเงื่อนไข เลข 2 ตัว ท้าย 3 ตัวท้าย ด้วยครับ ตรงนี้ผมใช้ string slice เทียบ
ก็มีเท่านี้ครับ ตั้งเงื่อนไขให้ถูกเป็นลำดับๆ ไป
```
...
```text
ก็ รับค่าเข้ามาเก็ยในตัวแปร ใช้ if เทียบค่าตามเื่อนไขต่างๆ  มีการใช้ string slice ในการ เลือกค่ามาเทียบครับ กำหนดลำดับการเทียบให้ถูก ครับ จากนั้น ก็ปริ้นออกมาครับ ผม
```
...
```text
ทดลอง เหมือน 3 ตัว หน้า แต่ 2 ตัวท้ายไม่
```
