...
```text
โจทย์ ให้ input = int 1 ตัว 
ซึ่ง จำนวนนั้นคือ หมายเลข ห้อง ที่อยู่ปราสาทจากที่โจทย์ กำหนด 
โดยตัวปราสาทนี่จะ มีฐานกว้างขึ้นเรื่อยๆ และ ชั้น สามารถดูได้จากห้องท้ายสุด จะเป็นเลข ยกกำลัง 2
โจทย์ต้องการแค่ว่า วิธีที่จะออกไปได้ คือ กี่วิธีที่น้อยที่สุด
```
...
```text
ตอนแรก ผมคิดจะใช้ list สร้างชั้นขึ้นมาทุกชั้นแล้ววนอยู่ในลิสต์ยังไงนี่แหละ แต่พออ่านโจทย์อีกที
เขาบอกว่า รูปที่ให้มาเป็แค่บางส่วนแปลว่า มันจะมีชั้นเพิ่มไปอีกการที่ผมจะเขียนเป็นลิสต์เลขห้องของแต่ละชั้นไม่น่าจะได้อะไร ทีนี้ ผมเลยมาหาแพทเทริน จนเจอว่า เลข ห้อง แถวขวาสุดสามารถใช้หาชั้นได้โดย มันคือ เลขชั้นยกกำลังสอง
ดังนั้น ผมเลยกำหนดชั้นมา โดยผมใช้ เป็นตัวแปร end = 0 ##ผมน่าจะสื่อประมาณว่า จบที่ชั้นนี้อะไรประมาณนั้น
และผมเลือกที่จะใช้วิธี เขียน while เพื่อ หาชั้นโดย ผมใช้เป็น
while True : ให้  end += 1 แล้วเมื่อ end**2 มากกว่าเหรือ เท่ากับ  n(เลขห้องที่ input มา) ให้ break 
ทีนี้ก็จะได้แล้วว่า ชั้น เท่ากับเท่าไหร่ก็มาตั้งเงื่อนไข 
โดย ปกติแต่ละชั้นจะมีวิธี ออกได้มากสุด 2 (ไม่รวมชั้น1)
จะได้ ex = end*2 -2 (ไม่นับชั้น1)
ตั้งเงื่อนไขแรกคือ ถ้า ex = 0 เนี่ย ให้ output = 0 เลย
แล้วก็มาตั้งเงื่อนไขว่าถ้าชั้นเป็นเลขคู่เหมือนกันให้ output =  ex ได้เลย
ส่วนถ้า เป็นเลขต่างชนิดกัน ให้ output = ex-1 เพราะวิธีจะน้อยลง 
สุดท้ายก็ปริ้นออกไป
...
```text
ทำคล้ายๆ วิธีแรกแต่ปรับเป็นฟังก์ชั่น และ ลองใช้การ รีเทริน หลักการคิดยังคงเดิม เพียงแค่ลองปรับให้โค้ดสั้นลง
```
