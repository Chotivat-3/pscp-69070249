...
```text
รับ อินพุท จำนวนครั้ง ที่จะ รับการกระทำเข้ามา จากนั้น รับการกระทำคือ + หรือ - เข้ามาตามจำนน
ต่อมาปริ้นผลลัพธ์ออกมา โดย ที่ ถ้าบวก จะเพิ่มทีละ 10 ถ้า ลด จะลด ทีละ 5
```
...
```text
สรั้างตัวแปรสำหรับเก็บค่า  output = 0 จากนั้นรับ n เข้ามา สร้างลูป โดย ใช้เป็น while n
รับค่า input มาเรื่อยๆ และ กำหนด ว่า ถ้า input = '+' ให้ output + 10 ถ้า input = '-' output - 5
สุดท้ายปริ้น output ออกมา
```
...
```text
เหมือนวิธีแรก ตั้งค่าสำหรับปริ้นออกไว้ และ รับค่าจำนวนเข้ามาจากนั้นรับอินพุทตามจำนวน
ต่อมาก็+-ตาามรnput จากนั้นปริ้น out ออกมา
```
