...
```text
ผมเข้าใจว่าโจทย์ให้รับค่า N มาแล้วทำให้เป็นเลขที่หาร10ลงตัวจากนั้นแสดงค่านั้นลบ10ลงไปเรื่อยๆจยเหลือ0
```
...
```text
แผนแรกผมคือรับค่ามาแล้วก็หาวิธีที่จะทำให้เลขมันหาร10ลงตัวแล้วก็ลูปลบไปเรื่อยๆจนเหลือ0
```
...
```text
วิธีสุดท้ายผมคือรับค่าNมาก่อนแล้วก็เอาเลขมา%10เพื่อให้ได้เศษที่เกินมาจากนั้นก็เอาค่า่Nมาลบกับเศษที่เกินก็จะได้เป็นเลขกลมๆที่หาร10ลงตัวจากนั้นก็ใช้while loopเพราะเราไม่รู้จำนวนที่เราจะลูปลบเลขที่แน่ชัดลูปลบ10ไปเรื่อยๆให้เหลือ0ละสุดท้ายก็ปริ้นresult
```
...
```text
เพราะเลขมีเศษที่ทำให้หาร10ไม่ลงตัวมา
```
